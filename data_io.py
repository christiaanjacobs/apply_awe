...
def load_data_from_npz(data_dir, min_length=None, overlap_labels=None):
    ...
    # if utt_key_split[0] not in overlap_labels:
        keys.append(utt_key)
        ...
        n_items += 1
    # else:
        # check_overlap_set.add(utt_key_split[0])
    ...
    # print("No. removed overlap labels", len(check_overlap_set))
